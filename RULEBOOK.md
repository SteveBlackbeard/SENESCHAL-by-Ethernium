...
AgentOps is a provider-neutral operations layer for AI agents. It exists to reduce cost, risk, and drift in assisted software work.

## Prime Rules

1. Keep AgentOps extractable.
2. Do not import AgentOps from Continuity Legacy runtime.
3. Do not package AgentOps into Continuity Legacy PyPI artifacts.
...
AgentOps should behave like an immune layer:
...
The smallest real AgentOps implementation is:
